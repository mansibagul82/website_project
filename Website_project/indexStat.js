function flag() 
{
    ...
    let contain = document.getElementsByClassName('sym1')
    flagcontainer && flagcontainer.map((c,index) =>
    {
        return(
            <span key = { index}  id= "spanjs">
                <img src={'https://flagcdn.com/${c}.svg'} width= "30" alt= {c}></img>
            </span>
        )
    })
}